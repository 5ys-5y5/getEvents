...
export function generateModelSummary(modelName, allTrades) {
  ...
  return {
    ...
    tradeCount,  // Keep for backward compatibility
    suggestedMaxCap: maxCap,
    suggestedLowCap: lowCap,
    avgReturn,
    winRate,
    // Add missing fields expected by saveTrackedPriceCache
    optimalHoldingDays: calculateOptimalHoldingDays(modelTrades),
    avgReturnByDay: null,  // Will be populated if needed
    winRateByDay: null,    // Will be populated if needed
    meta: {
