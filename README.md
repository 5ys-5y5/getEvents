...
- Supabase account (get from [Supabase](https://supabase.com/)) - Required for database features
...
2. **Configure environment**:
   ...
   **Note**: Without Supabase credentials, database features (analyst records, price tracking) will be disabled. The API will show a warning on startup:
   ```
